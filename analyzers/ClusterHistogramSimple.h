#ifndef MCMD_CLUSTER_HISTOGRAM_SIMPLE_H
#define MCMD_CLUSTER_HISTOGRAM_SIMPLE_H
...
namespace McMd
{
   ...
   /**
   * Identify micelle clusters in polymeric systems and only output one final data file with the cluster histogram
   */
   class ClusterHistogramSimple : public SystemAnalyzer<System>
   {
   ...
   public:
      ...
      */
      ClusterHistogramSimple(System &system);
   ...
   */
   template <class Archive>
   void ClusterHistogramSimple::serialize(Archive& ar, const unsigned int version)
   {
