#ifndef MCMD_CLUSTER_IDER_H
#define MCMD_CLUSTER_IDER_H
...
namespace McMd
{
   ...
   /**
   * Identifies clusters of molecules, such as micelles in the semigrand ensemble where the molecule can be in on of two states
   */
   class ClusterIdentifierMC 
   {
   ...
   public:
      ...
      */
      ClusterIdentifierMC(System &system);
