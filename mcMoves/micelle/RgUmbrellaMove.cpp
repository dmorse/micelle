...
namespace McMd
{
   ...
   */
   void RgUmbrellaMove::loadParameters(Serializable::IArchive &ar)
   {
      ...
      // TO BE ADDED: Either read in a functional form or list of values of energy and rg to interpolate
      // Currently reweighting function is a hard coded quadratic in teh move 
   ...
   */
   bool RgUmbrellaMove::move()
   {
      ...
      // Calculate the initial rg weighted energy
      Tensor momentTensor;
      ...
      double oldRgEnergy;
      // RG Weighting function; in the future this should be changed to be an actual function or interpolation of 
      // data that is fed into the MC move
	 ...
	 // barostat_energy = 1/2 (1/W) eta_x^2
      ...
      double newRgEnergy;
      // Again improve this to be an inputable function or an interpolation from an array of values read in
